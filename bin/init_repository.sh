...
gh secret set DOCKER_PASSWORD --body "myriamb26" --env "$environmentName"
gh secret set DOCKER_USENAME --body "dckr_pat_0EQmMcg_krYEp9PniqLKtK6RFjo" --env "$environmentName"
